...
We can write our recursive definition of `concatMap` in a **better** way, using two functions we've seen before, [[Concat|concat]] and [[Map (Function)|map]], and [[Function Composition (.)|function composition]]:
>[!Success]
>```Haskell
