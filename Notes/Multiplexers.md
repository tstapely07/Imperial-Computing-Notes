...
Here's a $4$ way multiplexer, built using a [[binary]] to **unary** converter (a [[Decoders|decoder]]): 
* Only one of the **decoders** outputs can be $1$ at a time.
* ![[Pasted image 20260409120408.png|403]]
