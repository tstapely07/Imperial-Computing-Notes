...
* By the [[Spectral Theorem]], all [[Eigenvectors and Eigenvalues|eigenvalues]] of the **covariance matrix** are non-negative real numbers.
* Each **eigenvalue** represents the **variance** of the data along its corresponding **eigenvector**.
	...
	* A smaller **eigenvalue** means it is narrowly spread.3